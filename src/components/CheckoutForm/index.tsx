  ...
  return (
    <div className="mx-auto max-w-2xl px-4 pb-24 pt-32 bg-gray-200 sm:px-6 lg:max-w-7xl lg:px-8">
      <div className="xl:gap-x-16 lg:gap-x-12 lg:grid-cols-2 grid max-w-[1200px]">
        <div>
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-700 dark:text-gray-700">
              Checkout
            </h2>
          </div>
          <div className="mt-10">
            ...
            <form onSubmit={onSubmit}>
              <div className="grid gap-6 mb-6 md:grid-cols-2 mt-4">
                <div>
                  ...
                  <input
                    ...
                    onFocus={onFocus}
                    onBlur={onBlur}
                    className="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-700 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  />
              ...
              >
                ...
                <button
                  ...
                  className={`${
                    disabled ? "disabled" : ""
                  } flex w-full items-center justify-center rounded-md border border-transparent bg-red-600 px-6 py-3 text-base font-medium text-gray-700 shadow-sm hover:bg-red-700`}
                >
                  Pay &nbsp;
                  <NumericFormat
        ...
        <div className="mt-10 lg:mt-0">
          <h2 className="text-lg font-medium text-gray-700">Ticket summary</h2>
